...
- CAP ve PACELC Teoremi ve ACID prensibleri
...
- Eğer bir sistem hem Consistent hem de  Partition Tolerant  (CP) ise Available (A) olamayacaktır. Çünkü sunuculardan biri sistemden düştüğü an artık diğer sunuculara yazdığımız verilerden haberdar olamayacaktır. Eğer yazmaya devam edersek sistemden kopan sunucu ile diğerleri arasında farklılık olacağından okumada problem yaşarız. Daha doğrusu yazma yapamayız ancak okuma yapabiliriz. Bu durumda yazma konusunda sistemin availability'si gitmiş oluyor. Sistemi ayakta tuamak için ilgili sunucuyu kapatmalı yada oraya hiç istek göndermemeliyiz. Böylece consistent ve partition tolerant bir sistem kurmuş oluruz.
...
CAP Teoreminin extend edilmiş halidir diyebiliriz. 
