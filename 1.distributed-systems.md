...
Örnek üzerinden gidecek olursak. Dağınık yapıda kullandığımız bir document DB'de doküman üzerinde yapılan bir değişiklik diğer sunuculara senkronize olana kadar geçen süre içinde değiştirdiğimiz doküman eğer read ve write concern'lerimiz uygunsa okunmaya devam edecektir. O vakte okunan doküman eski versiyonunu gösterecektir. T anında dokümanın güncel hali tün sunuculara ulaştığında consistency son tahlilde sağlanmış olacaktır. Geçte olsa ulaşılan bu consistency haline eventual consistency denir.
